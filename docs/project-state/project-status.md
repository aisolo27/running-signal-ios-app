...
- Verify Apple-style fixed-distance Work/Recovery rows against real structured workouts on the physical iPhone, especially planned-distance pace, HR, and cadence values in the interval detail UI.
