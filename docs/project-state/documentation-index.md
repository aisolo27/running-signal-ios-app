...
- `docs/validation/apple-fitness-interval-parity-dataset/paused-repeat-block-timer-rule-2026-06-15.md`: docs/debug timer rule for paused repeat blocks; preserves elapsed row windows, active/timer duration from paired HealthKit pause overlap, and blocked normal-detail status until prototype proof.
...
- `docs/validation/apple-fitness-interval-parity-dataset/ambiguous-repeat-tail-rule-2026-06-15.md`: docs/debug separator rule for repeat-tail ambiguity; requires repeat expansion, fixed final-row exhaustion, and open-cooldown guards before Open/Extra.
- `docs/validation/apple-fitness-interval-parity-dataset/simple-work-open-prototype-decision-2026-06-15.md`: Gate A docs/debug prototype boundary for exactly one fixed-distance Work step plus Open/Extra tail; no production UI approval.
...
- `docs/validation/apple-fitness-interval-parity-dataset/custom-workout-promotion-readiness-review-2026-06-15.md`: docs-only promotion-readiness decision after physical proof batches; recommends Gate A simple fixed-distance Work/Open as the safest next narrow normal-detail promotion candidate.
