...
- Simple fixed-distance Work/Open Gate A prototype boundaries are now defined in `docs/validation/apple-fitness-interval-parity-dataset/simple-work-open-prototype-decision-2026-06-15.md`: exactly one fixed-distance Work step, one complete HealthKit activity row, and a positive Open/Extra tail. This is future debug-prototype guidance only; normal workout detail remains blocked.
