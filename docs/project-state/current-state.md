...
- Next parity step: collect more Work + Open guard fixtures now that the active fixture Raw HealthKit Debug markdown and parity packet JSON exports with `activityBoundaryCandidateSummary` and `activityBoundaryCandidateIntervals` are archived.
