...
Historical context only. Load these only when the task explicitly asks for history, archaeology, stale-plan review, or archive cleanup.

## Archive Folders

- `docs/archive/completed-plans/*`
- `docs/archive/stale-plans/*`
- `docs/archive/old-research/*`
- `docs/archive/old-validation/*`
