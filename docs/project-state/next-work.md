...
- Recovery-containing Open/Extra docs/debug separator rule is now defined in `docs/validation/apple-fitness-interval-parity-dataset/recovery-containing-open-tail-rule-2026-06-15.md`; Raw HealthKit Debug and parity packet structured comparison now have a debug-only recovery-containing Open/Extra tail prototype path. Next proof is a fresh physical-iPhone export for May 1 confirming `supported`, preserved Recovery, and inferred post-final-row `Open / Extra`. Normal-detail UI promotion remains blocked.
- Ambiguous repeat-tail docs/debug separator rule is now defined in `docs/validation/apple-fitness-interval-parity-dataset/ambiguous-repeat-tail-rule-2026-06-15.md`; next work is simple fixed-distance Work/Open prototype discussion, not broad normal-detail UI promotion.
