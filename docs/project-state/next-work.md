...
- Paused repeat-block docs/debug timer rule is now defined in `docs/validation/apple-fitness-interval-parity-dataset/paused-repeat-block-timer-rule-2026-06-15.md`; next work is a debug-only prototype decision, not normal-detail UI promotion.
