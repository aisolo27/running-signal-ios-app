...
- Physical-iPhone Gate A exports for May 26, Jun 1, Jun 2, Jun 4, and Jun 12 are archived in `docs/validation/apple-fitness-interval-parity-dataset/physical-iphone-gate-a-work-open-proof-2026-06-15/`. They exposed that real one-step WorkoutKit blocks carry `repeatIndex == 1`; the debug gate was patched for that shape. Next proof needs a fresh on-device Raw HealthKit Debug/parity packet export from the fixed build for a simple Work/Open workout.
