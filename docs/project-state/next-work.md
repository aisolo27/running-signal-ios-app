...
- Simple fixed-distance Work/Open prototype boundary is now defined in `docs/validation/apple-fitness-interval-parity-dataset/simple-work-open-prototype-decision-2026-06-15.md`; the next step is deciding whether to implement a debug-only Parity Lab prototype, not normal-detail UI promotion.
