...
- Ambiguous repeat-tail docs/debug separator rule is now defined in `docs/validation/apple-fitness-interval-parity-dataset/ambiguous-repeat-tail-rule-2026-06-15.md`; next work is ambiguous repeat-tail proof/prototype discussion, not broad normal-detail UI promotion.
