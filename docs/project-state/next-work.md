...
- Paused repeat-block docs/debug timer rule is now defined in `docs/validation/apple-fitness-interval-parity-dataset/paused-repeat-block-timer-rule-2026-06-15.md`; Raw HealthKit Debug and parity packet structured comparison now have a debug-only paused repeat-block prototype path. Normal-detail UI promotion remains blocked. Next proof is a fresh physical-iPhone export for a paused repeat-block workout such as Apr 22, Apr 29, May 6, May 13, or May 27.
- Recovery-containing Open/Extra docs/debug separator rule is now defined in `docs/validation/apple-fitness-interval-parity-dataset/recovery-containing-open-tail-rule-2026-06-15.md`; next work is ambiguous repeat-tail cases, not normal-detail UI promotion.
