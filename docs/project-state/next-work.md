...
- The debug prototype build installed and launched on physical iPhone `AIS17PM` from commit `ef1284f`; next proof still needs a fresh on-device Raw HealthKit Debug/parity packet export for a simple Work/Open workout.
