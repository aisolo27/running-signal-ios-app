...
- **Entitlements File**: `Config/RunningWorkoutAnalysis.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/RunningWorkoutAnalysis.entitlements`:
