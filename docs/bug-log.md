...
- Rule: clean fixed-cooldown Open / Extra tail support does not approve recovery-containing tails, broader Work/Open promotion, or broad `HKWorkoutActivity` promotion. Repeat-block tails need their own exact-shape gate.
