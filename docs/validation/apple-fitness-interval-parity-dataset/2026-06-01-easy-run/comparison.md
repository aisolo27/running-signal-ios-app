...
Do not add a deterministic app rule from this workout alone. A final-distance-sample, private-session, sensor-end, or tail-shrink rule would need more fixed-distance Work + real Open tail evidence and would need to preserve June 2 and June 4, the simple Work + Open tail guard fixtures.
