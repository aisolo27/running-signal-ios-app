...
Historical note: this recommendation predates the later narrow normal-detail gates. Do not read it as saying the W/W/C open-cooldown gate is still pending. Read it as a preserved rule-definition checklist for future blocked shapes.
