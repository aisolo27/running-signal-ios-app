...
This is physical-iPhone proof that the narrow clean repeat-block gate works for May 20 and June 3 on the latest installed build.

This proof does not approve broad repeat-block promotion. April 22-style paused/timer-drift repeat blocks, May 1-style recovery/tail/pause cases, repeat-tail cases, and recovery-containing Open/Extra tail cases remain blocked.
