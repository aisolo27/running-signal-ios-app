...
3. Close blocked classes one at a time.
   ...
   1. Unresolved ambiguous repeat-tail cases. The clean June 10-style no-pause fixed-cooldown repeat tail is already closed; AIS-24 decides the next step is fallback/test hardening unless new evidence identifies a different exact narrow shape.
