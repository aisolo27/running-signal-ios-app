...
3. Close blocked classes one at a time.
   ...
   1. Unresolved ambiguous repeat-tail cases. The clean June 10-style no-pause fixed-cooldown repeat tail is already closed, and AIS-25 fallback tests lock the current unsupported paths unless new evidence identifies a different exact narrow shape.
